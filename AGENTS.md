...
tools/
  ...
  run_seethrough.py        Run the vendored See-through companion with a pinned profile
...
vendor/see-through/        Git submodule for experimental layer decomposition on Apple Silicon
